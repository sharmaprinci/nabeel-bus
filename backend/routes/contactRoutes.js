...
// /** ✉️ Create a new contact message */
...
// /** 🧾 Optional: Admin can get all contact messages */
...
//  * @desc    Admin sends a reply to a user message
...
//     // Optionally mark as resolved after reply
//     message.status = "resolved";

//     await message.save();

//     // Optional: Send an email reply (if you want)
//     // await sendEmail({
//     //   to: message.email,
